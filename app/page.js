  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--background))]">
      ...
      <div className="p-3">
        ...
        <h1 className="text-5xl font-bold text-black dark:text-white mb-4 text-center">
          ThreadsMC伺服器
        </h1>
        ...
        <h1 className="text-5xl font-bold text-black dark:text-white mb-4 text-center mt-10">
          現在就加入伺服器！
        </h1>
